...
CompareProbs <- cbind(Probs,Probs_cc,dp_qbar_syn,CInt,CInt_cc,CInt_syn)
...
colnames(CompareProbs) <- c("Orig. Data Q","CC Data Q","Full Model Q","Orig. Data L","Orig. Data U",
                            "CC Data L","CC Data U","Full Model L","Full Model U")
