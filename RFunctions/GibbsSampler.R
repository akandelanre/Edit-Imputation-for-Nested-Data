...
for(mc in 1:MCMCPara$n_iter){
  ...
  ## Sample alpha
  ModelPara$alpha <- rgamma(1,shape=(ModelPara$a_alpha+ModelPara$FF-1),rate=(ModelPara$b_alpha-log(ModelPara$pii[ModelPara$FF])))
  
  
  ## Sample beta
  ModelPara$beta <- rgamma(1,shape=(ModelPara$a_beta+(ModelPara$FF*(ModelPara$SS-1))),rate=(ModelPara$b_beta-sum(log(ModelPara$omega[,ModelPara$SS]))))
